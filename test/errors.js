    ...
    report.should.deep.equal({ valid: false,
      errors:
       [ { code: 'INVALID_TYPE',
           path: '',
           instance: [],
           message: '[] should be of type object not array',
           validator: 'type',
    ...
    report.should.deep.equal({ valid: false,
      errors:
       [ { code: 'ALL_OF_FAILED',
           path: '',
           instance: 1.5,
           message: '1.5 is not valid under all of the given schemas',
           validator: 'allOf',
           ...
           context:
            [ { valid: false,
                ...
                errors: [ { code: 'INVALID_TYPE',
                            path: '',
                            instance: 1.5,
                            message: '1.5 should be of type integer not number',
                            validator: 'type',
            ...
            [ { valid: false,
                ...
                errors:
                 [ { code: 'INVALID_TYPE',
                     path: '',
                     instance: [],
                     message: '[] should be of type string not array',
                     validator: 'type',
              ...
              { valid: false,
                ...
                errors:
                 [ { code: 'INVALID_TYPE',
                     path: '',
                     instance: [],
                     message: '[] should be of type number not array',
                     validator: 'type',
    ...
    report.should.deep.equal({ valid: false,
      errors:
       [ { code: 'ONE_OF_MULTIPLE',
           path: '',
           instance: 1,
           message: '1 is valid under each of the given schemas, but should be valid under only one of them',
           validator: 'oneOf',
           validator_value:
            [ { type: 'string' },
              { type: 'number' },
    ...
    report.should.deep.equal({ valid: false,
      errors:
       [ { code: 'NOT_PASSED',
           path: '',
           instance: 1,
           message: '1 should not match the given schema',
           validator: 'not',
    ...
    report.should.deep.equal({ valid: false,
      errors:
       [ { code: 'ARRAY_LENGTH_SHORT',
           path: '',
           instance: [ 1 ],
           message: '[ 1 ] is too short, minimum 3',
           validator: 'minItems',
           validator_value: 3,
    ...
    report.should.deep.equal({ valid: false,
      errors:
       [ { code: 'ARRAY_LENGTH_LONG',
           path: '',
           instance: [ 1, 2, 3, 4 ],
           message: '[ 1, 2, 3, 4 ] is too long, maximum 3',
           validator: 'maxItems',
           validator_value: 3,
       ...
       [ { code: 'ARRAY_UNIQUE',
           ...
           instance:
            [ { x: 1 },
              ...
              { x: 3 },
              { x: 1 } ],
           message: '[ { "x": 1 }, { "x": 2 }, { "x": 3 }, { "x": 1 } ] has non unique elements',
    ...
    report.should.deep.equal({ valid: false,
      errors:
       [ { code: 'OBJECT_PROPERTIES_MINIMUM',
           path: '',
           instance: {},
           message: '{} has less than the minimum of 2 properties',
    ...
    report.should.deep.equal({ valid: false,
      errors:
       [ { code: 'OBJECT_PROPERTIES_MAXIMUM',
           ...
           message: '{ "x": true, "y": "foo", "z": "boo" } has more than the maximum of 2 properties',
        ...
        errors:
         [ { code: 'ENUM_MISMATCH',
           ...
           { code: 'INVALID_TYPE',
             path: '/type',
             instance: null,
             message: 'null should be of type string not null',
             validator: 'type',
             relative_schema_path: '/type',
