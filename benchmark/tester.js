...
Tester.runOne = function (testName, testJson, testSchema, expectedResult, onlyTest) {
    ...
    this.validators.forEach(function (validatorObject) {
        ...
        // setup instance
        var instance = validatorObject.setup(schema);
...
Tester.runFile = function (filename) {
    ...
    this.runFileContent(content, { excludeTests: [] });
};
